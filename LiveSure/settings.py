"""
Django settings for LiveSure project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'your-fallback-secret-key-for-local-dev')
...
WSGI_APPLICATION = 'LiveSure.wsgi.application'
